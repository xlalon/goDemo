...
func (b *Band) NewAccount(ctx context.Context, label xchain.WalletLabel) (*xchain.AccountDTO, error) {
	_ = ctx
...
func (b *Band) GetWalletBalance(ctx context.Context, walletLabel xchain.WalletLabel, identity xchain.Identity) (xchain.Coin, error) {
	_ = ctx
	_ = walletLabel
	_ = identity
...
func (b *Band) GetAccountBalance(ctx context.Context, address xchain.Address, identity xchain.Identity) (xchain.Coin, error) {
